        ...
        <div className={classNames(projectcss.all, sty.column__xbQT)}>
          <div className={classNames(projectcss.all, sty.freeBox__suWom)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/copy_of_proliga_new_design/images/p1678T1861001000Png.png",
                fullWidth: 256,
                fullHeight: 256,
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicSearchComponent__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicSearchComponent__ArgsType, ReservedPropsType> &
