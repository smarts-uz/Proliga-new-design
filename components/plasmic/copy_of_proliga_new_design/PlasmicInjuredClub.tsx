  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img___21CfU, {
            [sty.imgvariant1___21CfUn50Zr]: hasVariant(
              $state,
              "variant1",
              "variant1"
            ),
            [sty.imgvariant2___21CfUuK3Nw]: hasVariant(
              $state,
              "variant2",
              "variant2"
            ),
            [sty.imgvariant3___21CfU80S75]: hasVariant(
              $state,
              "variant3",
              "variant3"
            )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img___1ZFj)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
