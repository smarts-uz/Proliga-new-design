    ...
    >
      <div className={classNames("all", sty.freeBox__sjtP6)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_new_design/images/images1Jfif.jpg",
            fullWidth: 300,
            fullHeight: 168,
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicBothImageTextCard__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicBothImageTextCard__ArgsType, ReservedPropsType> &
