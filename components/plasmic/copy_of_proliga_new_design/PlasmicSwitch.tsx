...
import sty from "./PlasmicSwitch.module.css"; // plasmic-import: hHMHnoOZA_CD/css
...
export type PlasmicSwitch__ArgsType = { onIsOnChange?: (val: any) => void };
