...
import sty from "./PlasmicInjuredTeamMember.module.css"; // plasmic-import: -ZjOM5ux0wjZ/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__nbl5O)}
          displayHeight={"auto"}
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__mccDq)}
          displayHeight={"20px"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_new_design/images/crossMedicalCircle512Webp.webp",
            fullWidth: 512,
            fullHeight: 512,
            aspectRatio: undefined
          }}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicInjuredTeamMember__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicInjuredTeamMember__ArgsType, ReservedPropsType> &
