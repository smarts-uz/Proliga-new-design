...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: q2VQxRgVHr2r/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: WDDaSJMd5buE/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__r3UJ)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__oDvx1)}
              />
            </React.Fragment>
          ),
          value: args.children
