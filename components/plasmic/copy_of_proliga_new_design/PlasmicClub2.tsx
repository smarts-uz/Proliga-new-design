...
function PlasmicClub2__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    ...
    player: usePlasmicDataOp(() => {
      return {
        sourceId: "8cdHi4ivRUEkK6qbegQevF",
        opId: "83f91bc7-099c-43f0-8f0b-8b728c61e4be",
        userArgs: {
          filters: [$queries.query.data[0].id]
        },
        cacheKey: `plasmic.$.83f91bc7-099c-43f0-8f0b-8b728c61e4be.$.`,
        invalidatedKeys: null,
    ...
    club: usePlasmicDataOp(() => {
      return {
        sourceId: "8cdHi4ivRUEkK6qbegQevF",
        opId: "aa275953-f939-4693-bac7-76bb67973bd3",
        userArgs: {},
        cacheKey: `plasmic.$.aa275953-f939-4693-bac7-76bb67973bd3.$.`,
        invalidatedKeys: null,
        roleId: "ead2b235-73a3-4579-b15a-7fc91fc1a23a"
      };
    })
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ijkpl)}>
              ...
              <div className={classNames(projectcss.all, sty.freeBox__k9IBd)}>
                <PlasmicImg__
                  ...
                  loading={"lazy"}
                  src={{
                    src: "/plasmic/copy_of_proliga_new_design/images/euroPng.png",
                    fullWidth: 512,
                    fullHeight: 512,
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicClub2__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicClub2__ArgsType, ReservedPropsType> &
